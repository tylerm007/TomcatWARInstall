...
function minErr(module) {
  return function () {
    ...
    setTimeout(function () {
    	return;
    	//patch for an expected error in the child grid which self-corrects on $apply()    
    	var bodyScope = angular.element('body').scope();
    	if (bodyScope && bodyScope) {
    		bodyScope.$root.$apply();
    	}
    }, 350);
...
function equals(o1, o2) {
	if (equalsEvent) { jQuery('body').trigger('equals', [o1, o2]); }
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse', '$browser',
    ...
    Scope.prototype = {
      ...
      $new: function(isolate) {
  	  ...
  	  if (!allTheChildren[child.$parent.$id]) {
  		allTheChildren[child.$parent.$id] = 1;
  	  }
  	  else {
  		allTheChildren[child.$parent.$id]++;
  	  }
        return child;
      },
